...
PROJECTS = [
    {
        ...
        'description': 'Engineered a specialized AI chatbot for chemistry, achieving a <strong>24x reduction in latency</strong> for generating 3D molecular models compared to Gemini 3.1 Pro benchmarks.',
    ...
    },
    {
        ...
        'description': 'A dual-tier AI guardrail system to detect mental health crises in youth facing virtual assistants, <strong>improving crisis recall by 9x</strong> (102 dataset test).',
    ...
    },
    {
        ...
        'description': 'A responsive personal portfolio website using Flask and Python for backend.',
